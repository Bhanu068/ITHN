...
from modules.trainer import TrainerITHN

from models.models import BaseCMNModelITHN
...
def parse_agrs():
    ...
    parser.add_argument('--visual_extractor', type=str, default='CLIPVisionModel', help='the visual extractor to be used.')
    ...
    parser.add_argument('--num_heads', type=int, default=12, help='the number of heads in Transformer.')
    ...
    parser.add_argument('--diversity_lambda', type=float, default=0.5, help='the temperature when sampling.')
    parser.add_argument('--sample_n', type=int, default=1, help='the sample number per image.')
    parser.add_argument('--group_size', type=int, default=1, help='the group size.')
    parser.add_argument('--output_logsoftmax', type=int, default=1, help='whether to output the probabilities.')
    parser.add_argument('--decoding_constraint', type=int, default=0, help='whether decoding constraint.')
    parser.add_argument('--block_trigrams', type=int, default=1, help='whether to use block trigrams.')
    parser.add_argument('--sample', type=bool, default=True, help='whether to use sampling or not')
    ...
    parser.add_argument('--model_name', type=str, required=True, help='checkpoint name for saving')
    parser.add_argument('--alpha', type=float, default=0.01, help='the rate of increase of hardness of synthesized harder negatives')
...
def main():
    ...
    args.vocab_size = len(tokenizer.idx2token) + 1
    ...
    model = BaseCMNModelITHN(args, tokenizer)
    ...
    trainer = TrainerITHN(model, criterion, metrics, optimizer, args, lr_scheduler, train_dataloader, val_dataloader, test_dataloader)
    trainer.train()
